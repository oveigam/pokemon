...
type SliderProps = Omit<BaseProps, "value" | "onValueChange"> & {
  value?: [number];
...
type RangerProps = Omit<BaseProps, "value" | "onValueChange"> & {
  value?: [number, number];
  onValueChange?: (value: [number, number]) => void;
};

const Ranger = React.forwardRef<React.ComponentRef<typeof SliderPrimitive.Root>, RangerProps>(
  ({ className, ...props }, ref) => (
    <SliderPrimitive.Root
      ref={ref}
      className={cn("relative flex w-full touch-none select-none items-center", className)}
